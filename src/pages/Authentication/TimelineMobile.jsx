...
const TimelineMobile = ({step = 0}) => {
    ...
    return (
        <>
            <ol className="flex items-center justify-center w-full relative md:hidden pt-2">
                <div className='flex items-center'>
                    ...
                    <div className={ `${ timeline > 2 ? 'bg-[#0D8A6A]' : 'bg-[#EAECF0]' } w-[80px] h-[2px]`}></div>
                </div>
                <div className='flex items-center'>
                    <li className="">
